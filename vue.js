Vue.component('pagecomp', {
    ...
    <div class="catalog">   
        <img src="https://upload.wikimedia.org/wikipedia/commons/f/f0/Spaghetti_aglio%2C_olio_e_peperoncino_%2816284859030%29.jpg" alt="West Cliff">
        <div class="desc">{{item.desc}}</div>
        <div class="leg">{{item.leg}}</div>
        <button class="btn" type="button">Add to Cart</button></div>
    <div class="catalog">
        <img src="https://upload.wikimedia.org/wikipedia/commons/6/6a/Jacques_Lameloise%2C_escab%C3%A8che_d%27%C3%A9crevisses_sur_gaspacho_d%27asperge_et_cresson.jpg" alt="North Cliff">
        <div class="desc">Red Crab</div>
        <div class="leg">Fresh from Alaska</div>
        <button type="button" class="btn btn-lg">Add to Cart</button></div>
    <div class="catalog">
        <img src="https://upload.wikimedia.org/wikipedia/commons/0/02/Breakfast_at_Irving_Street_Kitchen.jpg" alt="East Cliff">
        <div class="desc">Breakfast Special</div>
        <div class="leg">Good for the Soul</div>
        <button class="btn" type="button">Add to Cart</button></div>
    <div class="catalog">            
        <img src="https://upload.wikimedia.org/wikipedia/commons/4/4b/Seafood_linguine.jpg" alt="South Cliff">
        <div class="desc">Sea Shells mix</div>
        <div class="leg">For the shell Lovers</div>
        <button class="btn" type="button">Add to Cart</button></div>
    <div class="catalog">              
        <img src="https://upload.wikimedia.org/wikipedia/commons/a/a5/Various_kebab.jpg" alt="South Cliff">
        <div class="desc">Ultimate Kebab</div>
        <div class="leg">The best from middle east</div>
        <button class="btn" type="button">Add to Cart</button></div>
    <div class="catalog">              
        <img src="https://upload.wikimedia.org/wikipedia/commons/d/d9/Chicken_steak_with_pepper_sauce.jpg" alt="West Cliff">
    ...
    <div class="catalog">                   
        ...
        <button class="btn" type="button">Add to Cart</button></div>
    <div class="catalog">                    
        <img src="https://upload.wikimedia.org/wikipedia/commons/d/d4/Hamburguesa_de_carne.jpg" alt="South Cliff">
    ...
    <div class="catalog">                    
        ...
        <button class="btn" type="button">Add to Cart</button></div>
    <div class="catalog">                       
        <img src="https://upload.wikimedia.org/wikipedia/commons/d/d2/Stir_Fry_Wok_-_Free_For_Commercial_Use_-_FFCU_%2827159057131%29.jpg" alt="South Cliff">
